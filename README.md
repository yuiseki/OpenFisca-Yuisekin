...
```sh
pip install openfisca_yuisekin
```
...
```sh
git clone https://github.com/openfisca/openfisca-yuisekin.git
...
Substitute your package's country name for `openfisca_yuisekin` below:

```sh
curl -X POST -H "Content-Type: application/json" \
  -d @./openfisca_yuisekin/situation_examples/couple.json \
